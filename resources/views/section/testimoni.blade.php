        ...
        <div class="flex flex-col md:flex-row gap-8 max-w-6xl mx-auto">
            ...
            <div class="md:w-1/2 space-y-6">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    ...
                    <!-- Testimonial Text -->
                    <p class="text-gray-600 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec nisi libero, porttitor at maximus vehicula, pretium at purus. Aenean pellentesque dui sit amet est viverra.</p>
                    <!-- User -->
