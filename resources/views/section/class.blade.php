                ...
                <div class="relative rounded-2xl overflow-hidden bg-white shadow-lg transition duration-300 hover:shadow-xl">
                    ...
                    <div class="p-6 text-center">
                        <div class="mb-4 flex justify-center">
                            <img src="{{ asset('storage/'.$course->image) }}" alt="kelas 1" class="w-16 h-16 bg-purple-50 rounded-full">
                        </div>
                        ...
                        <button class="mt-6 w-full bg-dark-teal text-white py-3 rounded-xl transition duration-300 hover:bg-dark-teal/90 focus:outline-none focus:ring-2 focus:ring-hijau-500 focus:ring-offset-2">
                            Pilih Kelas
                        </button>
                    </div>
                </div>
